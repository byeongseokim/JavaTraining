...
public class Day {
	...
	// ---각 월의 일수 ---//
	private static int[][] mdays = { { 31, 28, 31, 30, 30, 31, 31, 30, 31, 30, 31 }, // 평년
			{ 31, 29, 31, 30, 30, 31, 31, 30, 31, 30, 31 }, // 윤년
	};
	...
	// ---월 설정---//
	public void setMonth(int month) { // 월 조정
		this.month = adjustedDay(year, this.month, date); // 일 조정
	}
